...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2110_object_test_sub0 = 0x01,
    .x2110_object_test = {0x00000001}
};
...
typedef struct {
    ...
    OD_obj_array_t o_2110_object_test;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2110_object_test = {
        .dataOrig0 = &OD_RAM.x2110_object_test_sub0,
        .dataOrig = &OD_RAM.x2110_object_test[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_TRPDO | ODA_MB,
        .dataElementLength = 4,
        .dataElementSizeof = sizeof(uint32_t)
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2110, 0x02, ODT_ARR, &ODObjs.o_2110_object_test, NULL},
